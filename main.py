...
russian_names = ["Sofia", "Anastasia", "Victoria", "Ksenia", "Arina", "Elizaveta", "Adelina", "Irina", "Yelena", "Polina", "Daria", "Natalia", "Svetlana", "Vera", "Nadezhda", "Galina", "Lyubov", "Aleksandra", "Maria", "Anna", "Angelina", "Marina", "Yekaterina", "Ludmila", "Tatiana", "Artyom", "Aleksandr", "Roman", "Yevgeny", "Ivan", "Maksim", "Denis", "Alexey", "Dmitry", "Danyl", "Sergey", "Nikolai", "Konstantin", "Nikita", "Mikhail", "Boris", "Victor", "Gennady", "Vyacheslav", "Vladimir", "Andrey", "Anatoly", "Ilya", "Kirill", "Oleg"]
entered_name = False
#debug_mode = False
...
def rr_win_screen(win_list, win_status):
    console_clear()
    print(Fore.GREEN + "As you stand next to a pile of {len(win_list)} bodies, you begin wonder: What am I gonna do with this money?")
...
def rr_main():
    ...
    current_num_competetors = input_number("How many people do you wish to compete with? (5 is reccomended): ", 1) 
    ...
    print(f"The odds of you surviving are not {round((1 / len(current_competetors) * 100), 2)}%.")
    input()
    ...
    while True:
        ...
        i = 0
        magazine = 0
        magazine = rr_load_magazine(current_competetors, current_status_of_competetors)

        while i <= current_max_num_competetors:
            if current_status_of_competetors[i] == True:
                rr_print_competetor_status(current_competetors, current_status_of_competetors)
                print()
