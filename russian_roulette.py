    ...
    while True:
        ...
        while True:
            ...
            for a in range(current_num_competetors):
                current_competetors.append(
                    rnd.choice(console_format.russian_names))
            ...
            input()
            console_format.clear()
            rr_continue = console_format.want_to_continue("Russian roulette™")
